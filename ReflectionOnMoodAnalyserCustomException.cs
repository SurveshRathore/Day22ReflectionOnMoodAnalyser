...
namespace Day22ReflectionMoodAnalyser
{
    internal class ReflectionOnMoodAnalyserCustomException
    {
        public static void ReflectionTest()
        {
            Type type = Type.GetType("Day22ReflectionMoodAnalyser.MoodAnalyserCustomException");
